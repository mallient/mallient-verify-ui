...
export const COUNTRY_ID_TYPES: Record<string, IdType[]> = {
  ...
  BR: [
    ...
    },
    {
      ...
      description:
        "Brazilian National Driver's License (Carteira Nacional de Habilitação)",
      requiresBackScan: true,
      hasBarcode: false,
    },
  ],
  ...
  IE: [
    ...
    driversLicenseEU(),
    {
      ...
      description:
        "Irish Public Services Card issued by the Department of Social Protection",
      requiresBackScan: true,
      hasBarcode: false,
    },
  ],
  ...
  JP: [
    ...
    },
    {
      ...
      description:
        "Japanese prefectural public safety commission driver's license",
      requiresBackScan: true,
      hasBarcode: false,
    },
    {
  ...
  AU: [
    passport(),
    {
      ...
      name: "Driver's Licence",
      description:
        "Australian state/territory driver's licence (barcode varies by state)",
      requiresBackScan: true,
      hasBarcode: true,
    },
    {
